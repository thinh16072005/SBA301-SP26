        ...
        <footer className="bg-light text-center py-4 mt-auto">
            ...
            <Container fluid>
                <Row className="align-items-center">
                    <Col xs={2}>
                        <Image src="/images/avatar.webp" alt="Author Avatar" className="rounded-circle" style={{ width: '60px', height: '60px', objectFit: 'cover' }} />
                    </Col>
                    <Col xs={8}>
                    ...
                    <Col xs={2}>
                        <a href="mailto:hungthinh16072005@gmail.com">hungthinh16072005@gmail.com</a>
                    </Col>
                </Row>
            </Container>
        </footer>
